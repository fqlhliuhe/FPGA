...
HD_PWD='D:/Vivado/shudianzuoye/zdshj/zdshj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buhuo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buhuo.tcl
