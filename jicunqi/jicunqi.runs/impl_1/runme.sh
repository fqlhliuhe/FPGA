...
HD_PWD='D:/Vivado/shudianzuoye/jicunqi/jicunqi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log jicu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source jicu.tcl -notrace
