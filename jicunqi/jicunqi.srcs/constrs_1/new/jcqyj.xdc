...
set_property IOSTANDARD LVCMOS18 [get_ports _OE]
set_property PULLDOWN true [get_ports CLR]
set_property PULLDOWN true [get_ports CLK]
set_property PULLDOWN true [get_ports _OE]
...
set_property PACKAGE_PIN V5 [get_ports _OE]
...
set_property PACKAGE_PIN T6 [get_ports {D[2]}]
set_property PACKAGE_PIN V7 [get_ports {D[1]}]
