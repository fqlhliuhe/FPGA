...
HD_PWD='D:/Vivado/shudianzuoye/RegStack/RegStack.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dcen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dcen.tcl
