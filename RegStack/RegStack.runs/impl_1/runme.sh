...
HD_PWD='D:/Vivado/shudianzuoye/RegStack/RegStack.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dcen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dcen.tcl -notrace
