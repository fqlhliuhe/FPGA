...
HD_PWD='D:/Vivado/shudianzuoye/ZLYM/ZLYM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dingceng.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dingceng.tcl
