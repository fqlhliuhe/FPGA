...
HD_PWD='D:/Vivado/shudianzuoye/ZLYM/ZLYM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dingceng.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dingceng.tcl -notrace
