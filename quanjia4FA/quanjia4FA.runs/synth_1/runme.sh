...
HD_PWD='D:/Vivado/shudianzuoye/quanjia4FA/quanjia4FA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FAsi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FAsi.tcl
