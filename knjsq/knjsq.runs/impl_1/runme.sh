...
HD_PWD='D:/Vivado/shudianzuoye/knjsq/knjsq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log knjsq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source knjsq.tcl -notrace
