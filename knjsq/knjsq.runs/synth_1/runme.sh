...
HD_PWD='D:/Vivado/shudianzuoye/knjsq/knjsq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log knjsq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source knjsq.tcl
