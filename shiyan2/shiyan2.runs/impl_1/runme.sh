...
HD_PWD='D:/Vivado/shudianzuoye/shiyan2/shiyan2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FAsi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FAsi.tcl -notrace
