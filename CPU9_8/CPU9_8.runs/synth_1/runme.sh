...
HD_PWD='D:/Vivado/shudianzuoye/CPU9_8/CPU9_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_D.tcl
