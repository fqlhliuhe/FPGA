...
HD_PWD='D:/Vivado/shudianzuoye/CPU9_8/CPU9_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_D.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_D.tcl -notrace
