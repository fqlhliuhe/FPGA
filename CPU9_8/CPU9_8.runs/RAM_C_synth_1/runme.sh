...
HD_PWD='D:/Vivado/shudianzuoye/CPU9_8/CPU9_8.runs/RAM_C_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_C.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_C.tcl
