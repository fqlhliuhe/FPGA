...
HD_PWD='D:/Vivado/shudianzuoye/4FA/4FA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FAs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FAs.tcl -notrace
