...
HD_PWD='D:/Vivado/shudianzuoye/ajxd/ajxd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ajxd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ajxd.tcl -notrace
