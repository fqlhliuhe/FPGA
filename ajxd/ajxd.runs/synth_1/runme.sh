...
HD_PWD='D:/Vivado/shudianzuoye/ajxd/ajxd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ajxd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ajxd.tcl
