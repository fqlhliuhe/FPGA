...
HD_PWD='D:/Vivado/shudianzuoye/three one/three one.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log huangle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source huangle.tcl
