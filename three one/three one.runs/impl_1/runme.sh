...
HD_PWD='D:/Vivado/shudianzuoye/three one/three one.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log huangle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source huangle.tcl -notrace
