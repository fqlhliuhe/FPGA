...
HD_PWD='D:/Vivado/shudianzuoye/chufaqi/chufaqi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zcjk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zcjk.tcl -notrace
