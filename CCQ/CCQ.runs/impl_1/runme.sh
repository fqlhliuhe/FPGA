...
HD_PWD='D:/Vivado/shudianzuoye/CCQ/CCQ.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpq.tcl -notrace
